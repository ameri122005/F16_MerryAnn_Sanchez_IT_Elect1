    ...
    >
      <View style={styles.card}>
        ...
        <Text style={styles.content}>
          ...
          opportunities—especially in industries like entertainment, fashion,
          and business.
        </Text>

        {/* ✅ FlatList with an optional header */}
        <FlatList
          ListHeaderComponent={
            comments.length > 0 ? (
              <Text style={styles.header}>Latest Comments</Text>
            ) : null
          }
          data={comments}
...
const styles = StyleSheet.create({
  ...
  content: { fontSize: 14, marginBottom: 12, color: "#333" },
  header: {
    fontSize: 16,
    fontWeight: "bold",
    marginBottom: 8,
  ...
  commentBar: { flexDirection: "row", alignItems: "center", marginTop: 12 },
  commentInput: {
    flex: 1,
    borderWidth: 1,
    borderColor: "#ccc",
